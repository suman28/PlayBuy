...
<%-- <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/materialize.min.css" media="screen,projection" > --%>
<link rel="stylesheet"
...
<body>
	...
	<div ng-controller="TabCtrl" class="demo" layout-align="end">
		<md-tabs md-no-ink md-border-bottom md-selected="selectedIndex" style="background-color:rgb(94,159,163);"> 
			<md-tab>
				<a href="#/login" data-ng-class="{ active: isActive('/login')}">Home</a>
			</md-tab>
			<!-- <md-tab> 
				<a href="#/profile" data-ng-class="{ active: isActive('/profile')}">About</a>
		    </md-tab> 
		    <md-tab>
				<a href="#/registration" data-ng-class="{ active: isActive('/registration')}">Contact</a>
		    </md-tab>
		    <md-tab>
				<a href="#/list" data-ng-class="{ active: isActive('/list')}">List</a>
			</md-tab> -->
			 <md-tab ng-hide=true>
				<a href="#/viewItem" ></a>
			</md-tab>

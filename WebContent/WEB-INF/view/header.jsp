...
<div ng-controller="AppCtrl">
	<md-toolbar  md-scroll-shrink style="background-color: rgb(94,159,163);">
	...
	<div layout="column">
		<section layout="row">
			<md-sidenav class="md-sidenav-left md-whiteframe-z2" id="sidenav"
				md-component-id="left" style="width:250px;min-width:230px;">
			...
			<div layout="row" class="space-around" layout-padding>
			 ...
			 <li class="list-navigation">
				<a href="#/login" class="navigation-link"><span
						class="sidemenu" layout-padding>Home</span></a></li>
				<!-- <li class="list-navigation"><a href="#/profile" class="navigation-link"><span
						class="sidemenu" layout-padding>Profile</span></a></li>
				<li class="list-navigation"><a href="#/registration" class="navigation-link">
				<span class="sidemenu"
						layout-padding>Contact Us</span></a></li> -->
						
				<li class="list-navigation"><a href="#/mobiles" class="navigation-link"><span class="sidemenu"
						layout-padding>Mobiles</span></a></li>
			</ul>

 ...
 angular.module('cisco_capital').controller('mobileCtrl', mobileCtrl);

 //filters
 angular.module('cisco_capital').filter("formatDate",FormatDate);
...
/* angular.module('cisco_capital').directive('menuToggle',menuToggle);
 angular.module('cisco_capital').directive('menuLink',menuLink);*/
 ...
 angular.module('cisco_capital').config(function($routeProvider) {
		...
		.when("/mobiles", {templateUrl : "mobiles", controller:"mobileCtrl"})
		.when("/viewItem", {templateUrl : "viewItem"})
